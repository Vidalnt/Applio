...
from rvc.lib.algorithm.firefly import FireFlyVQGAN
from rvc.lib.algorithm.vocos import VocosGAN
from rvc.lib.algorithm.refinegan import RefineGAN
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if use_f0:
            ...
            elif vocoder == "FireFlyVQGAN":
                self.dec = FireFlyVQGAN(
                    inter_channels,
